...
public class LongClickReceiver extends BroadcastReceiver {
    ...
    public static WeakReference<LucidLauncher> mWeakReference = new WeakReference(null);

    public static void getWeakReference(LucidLauncher launcher) {
        mWeakReference = new WeakReference(launcher);
    }

    @Override
    public void onReceive(Context context, Intent intent) {
        LucidLauncher launcher = (LucidLauncher) mWeakReference.get();
        if (launcher != null) {
