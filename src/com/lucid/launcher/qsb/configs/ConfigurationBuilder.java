 ...
 */
package com.lucid.launcher.qsb.configs;
...
import com.lucid.launcher.LucidLauncher;
import com.lucid.launcher.LucidLauncherCallbacks;
import com.lucid.launcher.qsb.AllAppsQsbContainer;
import com.lucid.launcher.search.nano.SearchProto.Columns;
import com.lucid.launcher.search.nano.SearchProto.AppIndex;
import com.lucid.launcher.search.nano.SearchProto.SearchBase;
import com.lucid.launcher.search.nano.SearchProto.SearchView;
import com.lucid.launcher.search.AppSearchProvider;
...
public class ConfigurationBuilder {
    ...
    public LucidLauncher mLauncher;
    ...
    public static Intent getSearchIntent(Rect sourceBounds, View gIcon, View micIcon) {
        ...
        return intent.putExtra("source_round_left", true)
                ...
                .setPackage(LucidLauncherCallbacks.SEARCH_PACKAGE).addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY | Intent.FLAG_ACTIVITY_NEW_TASK);
    }
