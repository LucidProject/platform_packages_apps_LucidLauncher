/*
 * Copyright (C) 2019 Lucid Project
 *
...
import com.lucid.launcher.qsb.QsbAnimationController;
...
public class LucidLauncherCallbacks implements LauncherCallbacks,
        SharedPreferences.OnSharedPreferenceChangeListener, OnChangeListener {
    public static final String SEARCH_PACKAGE = "com.google.android.googlequicksearchbox";

    private final LucidLauncher mLauncher;
    ...
    public LucidLauncherCallbacks(LucidLauncher launcher) {
        mLauncher = launcher;
    }
    ...
    private ClientOptions getClientOptions(SharedPreferences prefs) {
        boolean hasPackage = LucidUtils.hasPackageInstalled(mLauncher, SEARCH_PACKAGE);
